...
void main() async {
  WidgetsFlutterBinding
      .ensureInitialized(); // Asegurar que los widgets están inicializados
  ...
  final HttpLink httpLink = HttpLink('http://34.83.47.31:8080/graphql/');

  final AuthLink authLink = AuthLink(
    // Obtener el token de SharedPreferences
    getToken: () async =>
        'JWT ${prefs.getString(AUTH_TOKEN) ?? ''}', // Usar SharedPreferences
  );
